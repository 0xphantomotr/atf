...
def _help_text() -> str:
    return (
        ...
        "/google_folder LINKU - lidh folderin me projektin aktiv\n"
        "/google_check - kontrollon aksesin dhe ndryshimet pa import\n"
        "/google_sync - sinkronizon vetëm dokumentet e ndryshuara\n"
        "/google_status - shfaq llogarinë dhe folderin e lidhur\n"
        "/google_unbind - shkëput folderin nga projekti\n"
